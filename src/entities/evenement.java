...
//    
   ...
   private String lien;
    ...
    public String toString() {
        return "evenement{" + "id=" + id + ", nom=" + nom + ", description=" + description + ", type=" + type + ", prix=" + prix + ", datedeb=" + datedeb + ", datefin=" + datefin + ", adresse=" + adresse + ", image=" + image + ", idu=" + idu + ", particiate=" + particiate + '}';
    }
